var watchList = localStorage.getItem("watchList");
    ...
    for(let i=0; i<watchList.length; i++){
        axios.get(`https://api.themoviedb.org/3/movie/${watchList[i]}?api_key=8715a4d323d0baa4d3dd76d3a1241076`).then(
            (response) => {
                document.querySelector("#watchListCards").innerHTML+=( `
                <div class="col">
                ...
                <div class="content "> <a href="#">
                        ...
                        <div class="content-list">
                          <a href="#" class=" btn fs-4 text-danger" onclick="removeFromWatch(${response.data.id})" id="trash-btn"> <i class="fas fa-trash"></i></a>
...
function removeFromWatch(movieID) {
    var watchlist = localStorage.getItem("watchList");
    watchlist = JSON.parse(watchlist);
